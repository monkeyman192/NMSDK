...
class NMS_WarpAction(Node, NMSATNode):
    ...
    WarpType = EnumProperty(name = 'Warp Type',
                            description = 'Type of warp required. At the moment the only option is Blackhole',
...
class NMS_PlayAudioAction(Node, NMSATNode):
    ...
    Sound = StringProperty(name = 'Sound Name',
    ...
    OcclusionRadius = FloatProperty(name = 'Occlusion Radius',
...
class NMS_PlayAnimAction(Node, NMSATNode):
    ...
    Anim = StringProperty(name = 'Anim Name',
...
class NMS_GoToStateAction(Node, NMSATNode):
    ...
    State = StringProperty(name = 'Action State Name',
                           description = 'Name of the action state you wish to go to.')
    Broadcast = BoolProperty(name = 'Broadcast',
                           description = 'Whether or not to broadcast action to another scene.')
    BroadcastLevel = EnumProperty(name = 'Broadcast Levels',
...
class NMS_PainAction(Node, NMSATNode):
    ...
    AffectsPlayer = BoolProperty(name = 'Affects Player',
                                    description = 'Whether or not to affect player.')
...
class NMS_NodeActivationAction(Node, NMSATNode):
    ...
    NodeActiveState = EnumProperty(name = 'Node Active State Values',
...
class NMS_RewardAction(Node, NMSATNode):
    ...
    Reward = StringProperty(name = 'Reward ID',
...
class NMS_SpawnAction(Node, NMSATNode):
    ...
    Event = StringProperty(name = 'Event ID',
                           description = 'ID of the event from the game files you wish to spawn. Untested.')
...
class NMS_ParticleAction(Node, NMSATNode):
    ...
    Effect = StringProperty(name = 'Effect ID',
                           description = 'ID of the effect from the game files you wish to appear.')
    Joint = StringProperty(name = 'Joint name',
                           description = 'Name of the locator scene node where you wish the effect to appear at.')
    Exact = BoolProperty(name = 'Exact',
                         description = 'Unclear. Whether or not for effect to appear exactly on joint?')
...
class NMS_DisplayText(Node, NMSATNode):
    ...
    HUDTextDisplayTypeValues = EnumProperty(name = 'HUD Display Text Values',
...
class NMS_PlayerNearbyEvent(Node, NMSATNode):
    ...
    RequirePlayerAction = EnumProperty(name = 'Require Player Action',
                                       ...
                                       items = [("None", "None", "No special state"),
                                                ...
                                                ("On Foot Outside", "OnFootOutside", "Player must be on foot and outside"),
    ...
    AnglePlayerRelative = BoolProperty(name = "Angle Player Relative",
                                       description = "Angle is relative to player?")
    AngleOffset = FloatProperty(name = "Angle Offset",
                                description = "Offset of chosen angle...?")
    AngleReflected = BoolProperty(name = "Angle Reflected",
                                  description = "Reflection of chosen angle...?")
    AngleMinDistance = FloatProperty(name = "Angle Min Distance",
                                     description = "Minimum distance to chosen angle...?")
    DistanceCheckTypeValues = EnumProperty(name = 'Distance Check Type',
    ...
    Inverse = BoolProperty(name = "Inverse",
                           description = "If true this is triggered when the player is outside the specified distance")
...
class NMS_AnimFrameEvent(Node, NMSATNode):
    ...
    Anim = StringProperty(name = 'Anim Name',
                           description = 'Name of anim from game files you wish to activate upon[?]')
    FrameStart = IntProperty(name = "Frame Start",
                             description = "The frame on which to trigger actions.")
    StartFromEnd = BoolProperty(name = 'Start From End',
...
class NMSNodes():
    def __init__(self):
        self.node_categories = [NMSNodeCategory("ActionNodes", "Action Nodes", items = [NodeItem('NMS_GoToStateAction'),
    ...
    def register(self):
        ...
        # register menu item
        nodeitems_utils.register_node_categories("CUSTOM_NODES", self.node_categories)
