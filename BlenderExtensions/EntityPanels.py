...
class NMS_GcSimpleInteractionComponentData_Properties(bpy.types.PropertyGroup):
    ...
    SimpleInteractionType = EnumProperty(name = "SimpleInteractionType",
                                         items = [("Interact", "Interact", "Interact"),
                                                  ...
                                                  ("TeleportStartPoint", "TeleportStartPoint", "TeleportStartPoint"),
                                                  ...
                                                  ("NPCTerminalMessage", "NPCTerminalMessage", "NPCTerminalMessage"),
                                                  ("VehicleBoot", "VehicleBoot", "VehicleBoot"),
                                                  ("BiomeHarvester", "BiomeHarvester", "BiomeHarvester"),
                                                  ("FreighterGalacticMap" , "FreighterGalacticMap" , "FreighterGalacticMap")])
...
class NMS_GcInventoryTechProbability_Properties(bpy.types.PropertyGroup):
    ...
    DesiredTechProbability = EnumProperty(name = "DesiredTechProbability",
...
class NMS_GcSpaceshipClasses_Properties(bpy.types.PropertyGroup):
    ...
    ShipClass = EnumProperty(name = "ShipClass",
                             items = [("Freighter", "Freighter", "Freighter"),
                                      ...
                                      ("PlayerFreighter", "PlayerFreighter", "PlayerFreighter"),
                                      ("Royal", "Royal", "Royal")])
...
class NMS_GcInteractionType_Properties(bpy.types.PropertyGroup):
    ...
    InteractionType = EnumProperty(name = "InteractionType",
                                   items = [("None", "None", "None"),
                                            ...
                                            ("NPC_Anomaly_Secondary", "NPC_Anomaly_Secondary", "NPC_Anomaly_Secondary"),
                                            ("Ship", "Ship", "Ship"),
                                            ...
                                            ("AbandonedBuildings", "AbandonedBuildings", "AbandonedBuildings"),
                                            ...
                                            ("Teleporter_Station", "Teleporter_Station", "Teleporter_Station"),
                                            ("ClaimBase", "ClaimBase", "ClaimBase"),
                                            ("NPC_Freighter_Captain", "NPC_Freighter_Captain", "NPC_Freighter_Captain"),
                                            ("NPC_HIRE_Weapons", "NPC_HIRE_Weapons", "NPC_HIRE_Weapons"),
                                            ("NPC_HIRE_Weapons_Wait", "NPC_HIRE_Weapons_Wait", "NPC_HIRE_Weapons_Wait"),
                                            ("NPC_HIRE_Farmer", "NPC_HIRE_Farmer", "NPC_HIRE_Farmer"),
                                            ("NPC_HIRE_Farmer_Wait", "NPC_HIRE_Farmer_Wait", "NPC_HIRE_Farmer_Wait"),
                                            ("NPC_HIRE_Builder", "NPC_HIRE_Builder", "NPC_HIRE_Builder"),
                                            ("NPC_HIRE_Builder_Wait", "NPC_HIRE_Builder_Wait", "NPC_HIRE_Builder_Wait"),
                                            ("NPC_HIRE_Vehicles", "NPC_HIRE_Vehicles", "NPC_HIRE_Vehicles"),
                                            ("NPC_HIRE_Vehicles_Wait", "NPC_HIRE_Vehicles_Wait", "NPC_HIRE_Vehicles_Wait"),
                                            ("MessageBeacon", "MessageBeacon", "MessageBeacon"),
                                            ("NPC_HIRE_Scientist", "NPC_HIRE_Scientist", "NPC_HIRE_Scientist"),
                                            ("NPC_HIRE_Scientist_Wait", "NPC_HIRE_Scientist_Wait", "NPC_HIRE_Scientist_Wait"),
                                            ("NPC_Recruit", "NPC_Recruit", "NPC_Recruit"),
                                            ("NPC_Freighter_Captain_Secondary", "NPC_Freighter_Captain_Secondary", "NPC_Freighter_Captain_Secondary"),
                                            ("NPC_Recruit_Secondary", "NPC_Recruit_Secondary", "NPC_Recruit_Secondary"),
...
class NMS_TkModelRendererData_Properties(bpy.types.PropertyGroup):
    ...
    ThumbnailMode = EnumProperty(name = "ThumbnailMode",
                                 items = [("None", "None", "None"),
                                          ("HUD", "HUD", "HUD"),
                                          ("GUI", "GUI", "GUI")])
    FocusType = EnumProperty(name = "FocusType",
                             items = [("ResourceBounds", "ResourceBounds", "ResourceBounds"),
                                      ("ResourceBoundingHeight", "ResourceBoundingHeight", "ResourceBoundingHeight"),
...
class DATA_PT_entities(bpy.types.Panel):
    ...
    def GcSimpleInteractionComponentData(self, layout, obj):
        ...
        b1.row("SubstanceId")
        b1.listbox(self, obj, "NMS_GcSimpleInteractionComponentData_props.ActivationCost", "AltIds", "NMSString0x10_GcSimpleInteractionComponentData")
        b1.row("Cost")
        b1.row("Repeat")
        b1.row("RequiredTech")
        ...
        r.listbox(self, obj, "NMS_GcSimpleInteractionComponentData_props", "BaseBuildingTriggerActions", "GcBaseBuildingTriggerAction")

    def GcBaseBuildingTriggerAction(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcSimpleInteractionComponentData_props.BaseBuildingTriggerActions[index], layout)
        r.row("ID")
        r.row("TimeDelay")

    def NMSString0x10_GcSimpleInteractionComponentData(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcSimpleInteractionComponentData_props.ActivationCost.AltIds[index], layout)
        r.row("Value")
    ...
    def GcCustomInventoryComponentData(self, layout, obj):
        ...
        r.row("Size")
        r.listbox(self, obj, "NMS_GcCustomInventoryComponentData_props", "DesiredTechs", "GcInventoryTechProbability")
        r.row("Cool")

    def GcInventoryTechProbability(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcCustomInventoryComponentData_props.DesiredTechs[index], layout)
        r.row("Tech")
    ...
    def TkAudioComponentData(self, layout, obj):
        ...
        r.row("Ambient")
        r.row("MaxDistance")
        r.listbox(self, obj, "NMS_TkAudioComponentData_props", "AnimTriggers", "TkAudioAnimTrigger")

    def TkAudioAnimTrigger(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_TkAudioComponentData_props.AnimTriggers[index], layout)
        r.row("Sound")
        r.row("Anim")
        r.row("FrameStart")
    ...
    def GcInteractionComponentData(self, layout, obj):
        ...
        b1 = r.box("ActivationCost")
        b1.row("SubstanceId")
        b1.listbox(self, obj, "NMS_GcInteractionComponentData_props.ActivationCost", "AltIds", "NMSString0x10_GcInteractionComponentData_ActivationCost")
        b1.row("Cost")
        b1.row("Repeat")
        b1.row("RequiredTech")
        r.row("TriggerAction")
        ...
        b1.row("SubstanceId")
        b1.listbox(self, obj, "NMS_GcInteractionComponentData_props.SecondaryActivationCost_props", "AltIds", "NMSString0x10_GcInteractionComponentData_SecondaryActivationCost")
        b1.row("Cost")
        b1.row("Repeat")
        b1.row("RequiredTech")
        r.listbox(self, obj, "NMS_GcInteractionComponentData_props", "EventRenderers", "TkModelRendererData")
        ...
        r.listbox(self, obj, "NMS_GcInteractionComponentData_props", "PuzzleMissionOverrideTable", "GcAlienPuzzleMissionOverride")

    def TkModelRendererData(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcInteractionComponentData_props.EventRenderers[index], layout)
        b1 = r.box("Camera")
        b1.row("Distance")
        b2 = b1.box("Offset")
        b2.row("x")
    ...
    def GcAlienPuzzleMissionOverride(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcInteractionComponentData_props.PuzzleMissionOverrideTable[index], layout)
        r.row("Mission")
        r.row("Puzzle")

    def NMSString0x10_GcInteractionComponentData_ActivationCost(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcInteractionComponentData_props.ActivationCost_props.AltIds[index], layout)
        r.row("Value")

    def NMSString0x10_GcInteractionComponentData_SecondaryActivationCost(self, layout, obj, index = 0):
        r = RowGen(obj.NMS_GcInteractionComponentData_props.SecondaryActivationCost_props.AltIds[index], layout)
        r.row("Value")
...
class AddEntityStruct(bpy.types.Operator):
    ...
    structs = EnumProperty(items = [("GcObjectPlacementComponentData", "GcObjectPlacementComponentData", "Relates to placements of objects in the SelectableObjectsTable in Metadata"),
                                    ...
                                    ("GcSimpleInteractionComponentData", "GcSimpleInteractionComponentData", "The simpler interaction type"),
                                    ("GcInteractionComponentData", "GcInteractionComponentData", "Full interaction type"),
                                    ("GcAISpaceshipComponentData", "GcAISpaceshipComponentData", "Causes the object to be an AI spaceship"),
                                    ("GcCustomInventoryComponentData", "GcCustomInventoryComponentData", "Used to correlate with the inventory table"),
                                    ("TkAudioComponentData", "TkAudioComponentData", "Sets up an ambient soundscape around the object"),
                                    ("GcEncyclopediaComponentData", "GcEncyclopediaComponentData", "Lets the object appear in the encyclopedia"),
                                    ("GcEncounterComponentData", "GcEncounterComponentData", "Places sentry sentinals around the object (like a factory)"),
                                    ("GcSpaceshipComponentData", "GcSpaceshipComponentData", "Required to make a ship fly-able")])
...
class NMSEntities():
    ...
    def register():
        ...
        bpy.utils.register_class(NMS_GcSimpleInteractionComponentData_Properties)
        ...
        bpy.types.Object.NMS_GcSimpleInteractionComponentData_props = PointerProperty(type=NMS_GcSimpleInteractionComponentData_Properties)
        bpy.types.Object.NMS_GcCustomInventoryComponentData_props = PointerProperty(type=NMS_GcCustomInventoryComponentData_Properties)
        bpy.types.Object.NMS_GcAISpaceshipComponentData_props = PointerProperty(type=NMS_GcAISpaceshipComponentData_Properties)
        bpy.types.Object.NMS_TkAudioComponentData_props = PointerProperty(type=NMS_TkAudioComponentData_Properties)
        bpy.types.Object.NMS_GcEncyclopediaComponentData_props = PointerProperty(type=NMS_GcEncyclopediaComponentData_Properties)
        bpy.types.Object.NMS_GcEncounterComponentData_props = PointerProperty(type=NMS_GcEncounterComponentData_Properties)
        bpy.types.Object.NMS_GcSpaceshipComponentData_props = PointerProperty(type=NMS_GcSpaceshipComponentData_Properties)
        bpy.types.Object.NMS_GcInteractionComponentData_props = PointerProperty(type=NMS_GcInteractionComponentData_Properties)
    ...
    def unregister():
        ...
        bpy.utils.unregister_class(NMS_GcSimpleInteractionComponentData_Properties)
        bpy.utils.unregister_class(NMS_GcInventoryTechProbability_Properties)
        bpy.utils.unregister_class(NMS_GcCustomInventoryComponentData_Properties)
