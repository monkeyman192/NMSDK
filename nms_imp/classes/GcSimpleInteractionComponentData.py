...
STRUCTNAME = 'GcSimpleInteractionComponentData'
...
class GcSimpleInteractionComponentData(Struct):
    def __init__(self, **kwargs):
        ...
        self.data['SimpleInteractionType'] = kwargs.get('SimpleInteractionType', "Interact")
        ...
        self.data['SizeIndicator'] = kwargs.get('SizeIndicator', GcSizeIndicator())
        ...
        self.data['BaseBuildingTriggerActions'] = kwargs.get('BaseBuildingTriggerActions', List())
