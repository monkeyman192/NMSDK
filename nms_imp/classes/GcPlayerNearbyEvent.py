...
STRUCTNAME = 'GcPlayerNearbyEvent'
...
class GcPlayerNearbyEvent(Struct):
    def __init__(self, **kwargs):
        ...
        self.data['RequirePlayerAction'] = kwargs.get('RequirePlayerAction', "None")
        self.data['Distance'] = kwargs.get('Distance', 5)
        self.data['Angle'] = kwargs.get('Angle', 360)
        self.data['Distance'] = kwargs.get('Distance', 5)
        self.data['AnglePlayerRelative'] = bool(kwargs.get('AnglePlayerRelative', False))
        ...
        self.data['DistanceCheckType'] = kwargs.get('DistanceCheckType', "Radius")
