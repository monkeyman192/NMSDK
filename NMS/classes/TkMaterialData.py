...
class TkMaterialData(Struct):
    def __init__(self, **kwargs):
        ...
        self.data['Shader'] = String(kwargs.get('Shader', "SHADERS/UBERSHADER.SHADER.BIN"), 0x80)
        self.data['Flags'] = kwargs.get('Flags', List(TkMaterialFlags()))
        self.data['Uniforms'] = kwargs.get('Uniforms', List(TkMaterialUniform(Name="gMaterialColourVec4",
